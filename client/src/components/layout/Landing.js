  ...
  return (
    <Fragment>
      ...
      <section className='container'>
        ...
        <p>
          Outreach is a community for growing developers, Where all developers
          came as family and help eachother. The main aim of building a
          community was to give a platform where all developers can share their
          expertise, knowledge or mistakes they done as a being developer.
        </p>

        <p>
          The good thing is Outreach will be a platform for all developers out
          there You can ask your doubts about anything and other member of
          community will give you a answe.
        </p>
